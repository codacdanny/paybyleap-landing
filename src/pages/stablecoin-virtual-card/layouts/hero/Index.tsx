...
export function VirtualCardHero() {
  return (
    <section className="overflow-hidden bg-white  py-[82px] ">
      <LandingInset>
        <div className="flex w-full flex-col items-start gap-10 lg:flex-row lg:items-start">

          {/* ── Left: text content ── */}
          <div className="relative z-[2] w-full lg:w-[55%]">
            <h1 className="font-nohemi text-[34px] font-semibold leading-[1.12] tracking-[-0.035em] text-grey-90 sm:text-[44px] md:text-[64px]">
              Spend Crypto Globally
              <br />
              Using Virtual Card
            </h1>
            <p className="mt-[31px] max-w-[760px] text-[18px] font-normal leading-[1.22] tracking-[-0.01em] text-grey-80 sm:text-[24px] 2xl:mt-[8px]">
          ...
          <div className="relative w-full lg:w-[45%]">
            <img
              ...
              className="mx-auto w-full max-w-[420px] object-cover lg:w-[650px] lg:max-w-none"
            />

            {/* ── Overlay info card ── */}
            <div className="relative mx-auto mt-6 w-full max-w-[306px] rounded-2xl border border-grey-20 bg-white p-4 shadow-[0_4px_16px_rgba(0,0,0,0.08)] lg:absolute lg:bottom-[60px] lg:left-[-90px] lg:mx-0 lg:mt-0 lg:w-[306px]">
